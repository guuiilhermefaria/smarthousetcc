...
@Controller
@RequestMapping(value = "/relatoriocomodo")
public class ComodoRelatorio {
...
//        parameters.put("LOGO", ComodoRelatorio.class.getResource("/com/agrocomp/img/LogoAgroComp.png"));
        //Criando o relatório.
        InputStream report = ComodoRelatorio.class.getResourceAsStream("/com/smarthouse/controller/relatorio/relatorio_comodo.jasper");
